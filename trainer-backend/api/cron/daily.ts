...
//
// El scheduler real es el servicio 'cron' de Railway -> src/scripts/dailyCron.ts, que corre
// estas mismas tareas MÁS checkVencidas, todo en una sola corrida diaria.
//
