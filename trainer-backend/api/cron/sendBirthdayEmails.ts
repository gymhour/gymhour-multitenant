...
//
// ⚠️ Duplica lógica: reimplementa nodemailer y el HTML del mail de cumpleaños que ya viven en
// src/services/email.service.ts. Si hay que tocar los mails, se toca ALLÁ, no acá.
//
// El scheduler real es el servicio 'cron' de Railway -> src/scripts/dailyCron.ts
// La lógica vigente vive en src/services/nightly.service.ts (sendBirthdayEmails).
//
