...
export const getAllRutinasWithDetails = async (req: Request, res: Response): Promise<void> => {
    try {
        ...
        respondUnexpected(res, error, "cargar las rutinas");
    }
};
...
export const getRutinaById = async (req: Request, res: Response): Promise<void> => {
    ...
    if (isNaN(rutinaId)) {
        res.status(400).json({ message: "No pudimos identificar la rutina. Actualizá la página e intentá de nuevo." });
        return;
    }
    ...
    try {
        ...
        respondUnexpected(res, error, "cargar la rutina");
    }
};
...
export const updateRutinaWithBlocks = async (req: Request, res: Response): Promise<void> => {
    ...
    if (
        ...
        res.status(400).json({ message: "Faltan datos o alguno no es válido. Revisá el formulario." });
        return;
    }
    ...
    try {
        ...
        if (!rutinaFull) {
            res.status(404).json({ message: `Guardamos la rutina, pero no pudimos volver a cargarla. Actualizá la página.` });
            return;
        }
        ...
        respondUnexpected(res, error, "actualizar la rutina");
        return;
    }
};
...
export const createRutinaSimple = async (req: Request, res: Response): Promise<void> => {
    try {
        ...
        if (!rutinaConAsignaciones) {
            respondError(res, 500, "La rutina se creó, pero no pudimos mostrarla. Actualizá la página para verla.");
            return;
        }
...
export const deleteRutinaWithBlocks = async (req: Request, res: Response): Promise<void> => {
    ...
    try {
        ...
        respondUnexpected(res, error, "eliminar la rutina");
    }
};
...
export const getRutinasByUsuario = async (req: Request, res: Response): Promise<void> => {
    ...
    try {
        ...
        respondUnexpected(res, error, "cargar tus rutinas");
    }
};
...
export const getRutinasByEntrenador = async (req: Request, res: Response): Promise<void> => {
    ...
    if (isNaN(idEntrenador)) {
        res.status(400).json({ message: "No pudimos identificar al entrenador. Actualizá la página e intentá de nuevo." });
        return;
    }
    ...
    try {
        ...
        respondUnexpected(res, error, "cargar las rutinas del entrenador");
    }
};
...
export const getRutinasByDayOfWeek = async (req: Request, res: Response): Promise<void> => {
    ...
    if (!dayOfWeek) {
        res.status(400).json({ message: "Elegí un día de la semana." });
        return;
    }
    ...
    try {
        ...
        respondUnexpected(res, error, "cargar las rutinas del día");
    }
};
...
export const getRutinasAsignadas = async (req: Request, res: Response): Promise<void> => {
    try {
        ...
        respondUnexpected(res, error, "cargar las rutinas asignadas");
    }
};
