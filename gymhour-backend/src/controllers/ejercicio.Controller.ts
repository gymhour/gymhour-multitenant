...
export const createEjercicio = async (req: Request, res: Response): Promise<void> => {
    try {
        ...
        if (!nombre.trim()) {
            res.status(400).json({ message: "Escribí un nombre." });
            return;
        }
        ...
        respondUnexpected(res, error, "crear el ejercicio");
        return;
    }
};
...
export const getAllEjercicios = async (_req: Request, res: Response): Promise<void> => {
    try {
        ...
        respondUnexpected(res, error, "cargar los ejercicios");
        return;
    }
};
...
export const getEjercicioById = async (req: Request, res: Response): Promise<void> => {
    try {
        ...
        respondUnexpected(res, error, "cargar el ejercicio");
        return;
    }
};
...
export const updateEjercicio = async (req: Request, res: Response): Promise<void> => {
    try {
        ...
        if (error.code === 'P2025') {
            res.status(404).json({ message: "No encontramos ese ejercicio." });
        } else {
            respondUnexpected(res, error, "actualizar el ejercicio");
        }
        return;
    }
};
...
export const deleteEjercicio = async (req: Request, res: Response): Promise<void> => {
    try {
        ...
        respondUnexpected(res, error, "eliminar el ejercicio");
    }
};
