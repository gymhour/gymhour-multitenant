...
export async function sendWelcomeEmail(email: string, nombre: string): Promise<void> {
  ...
  const subject = `¡Bienvenido a Gymhour, ${displayName}! 💪`;
...
<html lang="es">
  <head>
    ...
    <title>¡Bienvenido a Gymhour!</title>
    <style>
          ...
          <table width="640" cellpadding="0" cellspacing="0" border="0" style="max-width:640px; width:100%; background:#ffffff; border-radius:12px; overflow:hidden; box-shadow:0 8px 30px rgba(0,0,0,0.06);">
            ...
            <tr>
              <td align="center" valign="middle"
                  bgcolor="#DA4632"
                  style="background: linear-gradient(90deg, #DA4632 0%, #B93C2B 100%); padding:28px; text-align:center; color:#ffffff !important; mso-color-alt:#ffffff;">
                ...
                <h1 style="margin:0; font-size:28px; line-height:1.05; font-weight:700; color:#000000 !important; mso-color-alt:#000000; mso-line-height-rule:exactly;">
                  <span style="color:#ffffff !important;">¡Bienvenido, ${displayName}! 💪</span>
                </h1>

                <p style="margin:8px 0 0; font-size:16px; color:#000000 !important; mso-color-alt:#000000;">
                  <span style="color:#ffffff !important;">Gracias por unirte a Gymhour — tu lugar para entrenar y mejorar cada día.</span>
                </p>
              </td>
            </tr>
            ...
            <tr>
              <td style="padding:22px; color:#111827;">
                <p style="margin:0 0 12px; font-size:15px; line-height:1.5; color:#111827;">
                  Gracias por unirte a <strong>Gymhour</strong>. Aquí podrás reservar clases, registrar tu progreso, ver rutinas y cuotas.
                </p>
                ...
                <div style="text-align:center; margin:18px 0;">
                  ...
                  <a
                    ...
                    style="display:inline-block; background:#DA4632; color:#ffffff !important; padding:12px 20px; border-radius:8px; font-weight:700; border:1px solid rgba(0,0,0,0.08); box-shadow:0 6px 18px rgba(218,70,50,0.18);"
                  >
                    Visitar mi cuenta
                  </a>
                </div>
            ...
            <tr>
              <td style="padding:14px 18px; border-top:1px solid #f3f4f6; text-align:center;">
                <span style="font-size:12px; color:#9ca3af;">
                  Gymhour • ${new Date().getFullYear()} • Potenciando tu bienestar.
                </span>
              </td>
            </tr>
          </table>
    ...
    <div class="wrap">
      <div class="card">
        <div class="hero">
          ...
          <p>Has solicitado un cambio de contraseña en Gymhour.</p>
        </div>
        <div class="content">
        ...
        <div class="footer">
          Gymhour • ${new Date().getFullYear()} • Protegiendo tu acceso.
        </div>
      </div>
    </div>
  </body>
...
export async function sendBirthdayEmail(email: string, nombre?: string): Promise<void> {
  const displayName = nombre ? nombre : "amigo/a de Gymhour";
  const frontendUrl = process.env.FRONTEND_URL ?? "#";
      ...
      <div class="email-wrap" role="article" aria-roledescription="email" aria-label="Feliz cumpleaños">
        <div class="card" role="presentation">
          ...
          <div class="content">
            ...
            <p class="text">
              Todo el equipo de <strong>Gymhour</strong> te desea un día increíble. Gracias por ser parte de nuestra comunidad:
          ...
          <div class="footer">
            Gymhour • ${new Date().getFullYear()} • Si no querés recibir este tipo de correos, ingresá a tu perfil y desactivá notificaciones.
          </div>
  ...
  <body>
    <div class="wrap">
      <div class="card">
        ...
        <div class="footer">Gymhour • ${new Date().getFullYear()}</div>
      </div>
    </div>
  </body>
</html>`;
